...
#undef FRIENDLY_NAME
#define FRIENDLY_NAME    "moist01"

#undef MQTT_HOST
#define MQTT_HOST       "192.168.1.18"                // [MqttHost]
...
#undef  MQTT_USER
#define MQTT_USER       "szunyog"         // [MqttUser] Optional user

#undef MQTT_TOPIC
#define MQTT_TOPIC      "moist01"
...
#undef APP_TIMEZONE
#define APP_TIMEZONE           0                 // [Timezone] +0 hour = UTC
